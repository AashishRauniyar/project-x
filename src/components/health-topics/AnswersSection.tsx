    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            All health advice articles have been written by registered medical
            health experts, doctors and pharmacists. We strive to be your first
            choice when looking for reliable answers to any health questions you
            may have. We bring together a team of medical reviewers and wellness
            experts to answer your health questions and give recommendations.
          </p>
