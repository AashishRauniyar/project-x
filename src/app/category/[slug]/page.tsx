...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: "Category - HealthScopeDaily",
          ...
          {posts.length > 0 ? (
            ...
            <div className="bg-white rounded-lg p-12 shadow-sm text-center">
              ...
              <p className="text-gray-600 mb-6">
                There are no articles in the &quot;{category.name}&quot;
                category yet.
              </p>
              <Link
                href="/"
          ...
          <div className="mt-12 bg-white rounded-lg p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Link
                ...
                className="bg-primary-50 hover:bg-primary-100 rounded-lg p-4 text-center transition-colors"
              >
              ...
              <Link
                ...
                className="bg-secondary-50 hover:bg-secondary-100 rounded-lg p-4 text-center transition-colors"
              >
                <div className="text-secondary-600 font-medium">Nutrition</div>
              </Link>
              <Link
                href="/category/supplements"
                className="bg-accent-50 hover:bg-accent-100 rounded-lg p-4 text-center transition-colors"
              >
                <div className="text-accent-600 font-medium">Supplements</div>
              </Link>
              <Link
                href="/category/beauty"
                className="bg-neutral-50 hover:bg-neutral-100 rounded-lg p-4 text-center transition-colors"
              >
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              We encountered an error while loading this category. Please check
