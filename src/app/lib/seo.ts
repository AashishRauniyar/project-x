...
export const siteConfig = {
  ...
  description:
    "Expert supplement reviews and wellness tips for a healthier lifestyle",
  url: "https://www.healthscopedaily.com",
  ogImage: "https://www.healthscopedaily.com/HealthScopeDaily.png",
  twitter: "@healthscopedaily",
  author: "HealthScopeDaily Team",
};
...
export function extractStructuredData(yoastHead: string) {
  const scriptMatch = yoastHead.match(
...
export function generatePostMetadata(post: Post): Metadata {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        yoastData.og_description || metaTags.ogDescription || description,
    ...
    twitter: {
      card:
        yoastData.twitter_card || metaTags.twitterCard || "summary_large_image",
      title: yoastData.twitter_title || metaTags.twitterTitle || title,
      description:
        yoastData.twitter_description ||
...
export function generateCategoryMetadata(category: Category): Metadata {
  ...
  const ogImage =
    yoastData.og_image?.[0]?.url || metaTags.ogImage || siteConfig.ogImage;
