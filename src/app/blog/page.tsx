    ...
    posts = [
      {
        ...
        content: {
          rendered:
            "<p>Discover the most effective natural supplements for optimal health and wellness. Learn about the science-backed benefits of vitamins, minerals, and herbal extracts that can transform your well-being...</p>",
        },
        excerpt: {
          rendered:
            "Discover the most effective natural supplements for optimal health and wellness.",
        },
      ...
      },
      {
        id: 2,
        title: {
          rendered: "Top 10 Anti-Aging Skincare Ingredients You Need to Know",
        },
        content: {
          rendered:
            "<p>Aging is inevitable, but the right skincare ingredients can help slow down the process. From retinoids to vitamin C, discover the powerhouse ingredients that dermatologists swear by...</p>",
        },
        excerpt: {
          rendered:
            "Aging is inevitable, but the right skincare ingredients can help slow down the process.",
        },
      ...
      },
      {
        id: 3,
        title: {
          rendered: "Managing Blood Sugar Naturally: Evidence-Based Strategies",
        },
        content: {
          rendered:
            "<p>Maintaining healthy blood sugar levels is crucial for overall health. Learn about natural methods, dietary changes, and lifestyle modifications that can help stabilize your glucose levels...</p>",
        },
        excerpt: {
          rendered:
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Expert insights, evidence-based articles, and the latest
              discoveries in health, wellness, and nutrition
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mt-16 bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-primary-100 mb-6 max-w-2xl mx-auto">
            Get the latest health insights, expert reviews, and wellness tips
...
export const metadata = {
  title: "Health & Wellness Blog - HealthScopeDaily",
  description:
    "Expert insights, evidence-based articles, and the latest discoveries in health, wellness, and nutrition. Stay informed with our comprehensive health blog.",
  keywords:
    "health blog, wellness articles, nutrition tips, supplement reviews, healthy lifestyle",
};
