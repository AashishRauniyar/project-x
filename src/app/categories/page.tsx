    ...
    categoriesHierarchy = [
      {
        ...
        count: 45,
        description:
          "Comprehensive health guides covering various aspects of wellness and medical topics.",
        link: "",
        ...
        children: [
          {
            ...
            slug: "blood-sugar",
            count: 8,
            description: "Blood sugar management and diabetes prevention",
            link: "",
            taxonomy: "category" as const,
            parent: 15,
            meta: {},
          ...
          },
          {
            ...
            slug: "bodybuilding",
            count: 12,
            description: "Muscle building and fitness supplements",
            link: "",
            taxonomy: "category" as const,
            parent: 15,
            meta: {},
          ...
          },
          {
            ...
            slug: "bone-products",
            count: 7,
            description: "Bone health and calcium supplements",
            link: "",
            taxonomy: "category" as const,
            parent: 15,
            meta: {},
      ...
      },
      {
        ...
        count: 25,
        description:
          "Skincare products, anti-aging solutions, and beauty treatments.",
        link: "",
        taxonomy: "category" as const,
        parent: 0,
        meta: {},
      ...
      },
      {
        ...
        count: 20,
        description:
          "Weight management supplements and healthy lifestyle tips.",
        link: "",
        taxonomy: "category" as const,
        parent: 0,
        meta: {},
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm mt-6 mb-8 border border-gray-100">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              Explore our comprehensive collection of health and wellness
              topics. Find expert reviews, trusted advice, and evidence-based
              information across all health categories.
            </p>
        ...
        <div className="mt-16 bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-primary-100 mb-6 max-w-2xl mx-auto">
            Our health experts are constantly adding new content. Subscribe to
            our newsletter to stay updated with the latest health insights and
            product reviews.
          </p>
